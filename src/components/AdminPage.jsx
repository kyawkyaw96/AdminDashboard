...
const AdminPage = () => {
  ...
  return (
    <div className="relative w-full overflow-auto rounded-2xl bg-kanban py-2">
      {/* <!-- /* ------------------------------ Kanban Header -----------------------------  --> */}
      <div className="flex w-full items-center justify-between px-3 py-2">
        <div className="flex items-center gap-2">
          <h3 className="font-medium text-main-text sm:text-lg">Todo</h3>
          <span className="flex h-5 w-5 items-center justify-center rounded-full bg-surface text-xs font-medium text-muted-text">
            3
          </span>
        </div>
        <button className="disabled:text-muted-text/75-text inline-flex h-7 w-7 items-center justify-center gap-1 rounded-full text-sm text-muted-text hover:bg-accent hover:text-main-text">
          <svg
            stroke="currentColor"
            fill="none"
            stroke-width="2"
      ...
      {/* <!-- /* ----------------------------- Kanban Content -----------------------------  --> */}
      <div className="space-y-4 px-4 py-2 w-full flex flex-wrap gap-3 ">
        {/* <!-- /* ---------- Kanban Card ----------  --> */}
        <div className="w-5/12 cursor-pointer space-y-4 rounded-lg bg-surface p-4">
          ...
          {/* <!-- Kanban Card Footer --> */}
          <div className="flex items-center gap-2 text-muted-text sm:gap-4">
            ...
            <div className="flex w-full items-center justify-end -space-x-2">
              <div className="relative flex h-6 w-6 shrink-0 items-center justify-center overflow-hidden rounded-full bg-muted text-xs ring-1 ring-muted-text/75">
                <img
                  alt="avatar"
        ...
        {/* <!-- /* ---------- Kanban Card ----------  --> */}
        <div className="relative w-5/12 cursor-pointer space-y-4 rounded-lg bg-surface p-4">
          <h5 className="w-10/12 text-sm font-medium">
